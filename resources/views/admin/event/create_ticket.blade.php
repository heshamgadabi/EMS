...
<div class="col-md-10">
  <div class="card card-secondary card-outline mb-4">
   ...
   <form method="POST" action="{{ route('event.ticket.store', $event->id) }}" >
    @csrf
    <div class="row">
        <div class="col-md-6">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="decimal" name="price" class="form-control" value="{{ old('price') }}" id="price" aria-describedby="priceHelp" />
...
@section('breadcrumb')
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Create Ticket for {{ $event->title }}</h3>
              </div>
              <div class="col-sm-6">
