        ...
        <div class="row g-4 g-lg-5">
          ...
          <div class="col-lg-8">
            <div class="event-detail-header mb-4">
              <h1 class="page-title mb-4">باتل كارت يوم النساء - جدة</h1>
            ...
            <div class="event-section border-bottom pb-4 mb-4">
              ...
              <div class="event-description">
                <p>
                  باتل كارت هي أول سيارات سباق كارتنغ حقيقي في العالم بمزيج
                  ألعاب الفيديو جيم، والواقع المعزز. تخيل مجموعة مختلفة من أنواع
                  الألعاب التي تنقل السباق إلى حرب والسيارة تطلق صواريخ لإيقاف
                  الاعبين الأخرين، غير الأسلحة الأخرى مثل النيتروس، قنابل، و
                  برميل الزيت. مزيد من أنواع الألعاب المختلفة متاحة مثل كرة قدم
                  بالسيارة، لعبت الثعبان، و كثير من الألعاب الأخرى. جاهزين
                  للتحدي؟
                </p>
                <h3 class="event-description-subheading">الشروط والاحكام:</h3>
                <ul class="event-terms-list">
                  <li>يجب أن يكون طولك 145 سم على الأقل للعب.</li>
                  <li>
                    تحتاج إلى مسح التذاكر الخاصة بك عند الوصول وتسجيل الأسماء في
                    مكتب دخول BATTLEKART.
                  </li>
                  <li>
                    تذكرة تيكت فلو لا تحجز لك موعد محدد. سيتم تسجيل أسماء
                    اللاعبين في أقرب موعد متاح عند الوصول و إن لم يجد مواعيد
                    متاحة في نفس اليوم، سيتم الحجز في أقرب موعد متاح على حسب
                    رغبتك.
                  </li>
                  <li>جميع التذاكر غير قابلة للاسترداد.</li>
                  <li>يرجى تحمل معنا أي تأخير محتمل قد يحدث في الموقع.</li>
                  <li>
                    يجب احترام اللاعبين الآخرين على المضمار في جميع الأوقات.
                  </li>
                </ul>
              </div>
            </div>
